...
import googleIcon from "../src/images-icons/googleIcon.png";
import appleIcon from "../src/images-icons/appleIcon.png";
import linkedInIcon from "../src/images-icons/linkedInIcon.png";
import discordIcon from "../src/images-icons/discordIcon.png";
import githubIcon from "../src/images-icons/githubIcon.png";
import twitterIcon from "../src/images-icons/twitterIcon.png";
    ...
    <div className="landing-page-parent flex flex-col sm:flex-row min-h-screen">
      ...
      <div className="right-sec w-full sm:w-1/2 pt-11">
        ...
        <div className="flex signIn-options mt-6 ml-4 sm:ml-32 mr-4 sm:mr-32">
          <button
            className="bg-white px-4 rounded-lg text-gray-300 h-10 flex items-center w-full sm:w-1/2 mr-2 sm:mr-5"
          >
            <img src={googleIcon} className="w-6 h-6 mr-2" alt="Google Icon" />
            Sign in with Google
          </button>
          <button
            className="bg-white px-4 rounded-lg text-gray-300 h-10 flex items-center w-full sm:w-1/2"
          >
        ...
        <h6 className="ml-4 sm:ml-20 mr-4 sm:mr-20 text-center mb-7">
          Don't have an account <span className="font-medium text-blue-500 cursor-pointer">Register here?</span>
        </h6>
      </div>
    </div>
  );
